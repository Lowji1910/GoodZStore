  ...
  <div style="display:flex;align-items:center;justify-content:space-between;max-width:1200px;margin:auto;padding:0 24px;height:70px;">
    ...
    <nav style="flex:1;text-align:center;">
      <ul style="display:inline-flex;gap:32px;list-style:none;margin:0;padding:0;font-size:1.1rem;font-weight:500;">
        <li><a href="/Views/Users/index.php" style="color:#222;text-decoration:none;">Trang chủ</a></li>
        <li style="position:relative;">
          <a href="/Views/Users/categories.php" style="color:#222;text-decoration:none;">Danh mục ▼</a>
          <div class="dropdown-menu" style="display:none;position:absolute;left:0;top:32px;background:#fff;box-shadow:0 2px 8px #eee;border-radius:8px;padding:12px 0;min-width:220px;">
            <a href="/Views/Users/categories.php?type=aothun" style="display:flex;align-items:center;gap:8px;padding:8px 24px;color:#222;text-decoration:none;">
              <img src="/img/shirt.png" alt="Áo thun" style="width:24px;">Áo thun
            </a>
            <a href="/Views/Users/categories.php?type=quanjeans" style="display:flex;align-items:center;gap:8px;padding:8px 24px;color:#222;text-decoration:none;">
              <img src="/img/jeans.png" alt="Quần jeans" style="width:24px;">Quần jeans
            </a>
            <a href="/Views/Users/categories.php?type=aokhoac" style="display:flex;align-items:center;gap:8px;padding:8px 24px;color:#222;text-decoration:none;">
              <img src="/img/jacket.png" alt="Áo khoác" style="width:24px;">Áo khoác
            </a>
            <a href="/Views/Users/categories.php?type=vaynu" style="display:flex;align-items:center;gap:8px;padding:8px 24px;color:#222;text-decoration:none;">
              <img src="/img/dress.png" alt="Váy nữ" style="width:24px;">Váy nữ
            </a>
            <a href="/Views/Users/categories.php?type=phukien" style="display:flex;align-items:center;gap:8px;padding:8px 24px;color:#222;text-decoration:none;">
              <img src="/img/accessory.png" alt="Phụ kiện" style="width:24px;">Phụ kiện
            </a>
          </div>
        </li>
  <li><a href="/Views/Users/promotions.php" style="color:#222;text-decoration:none;">Khuyến mãi</a></li>
  <li><a href="/Views/Users/contact.php" style="color:#222;text-decoration:none;">Liên hệ</a></li>
  <li><a href="/Views/Users/about.php" style="color:#222;text-decoration:none;">Giới thiệu</a></li>
      </ul>
    </nav>
    <!-- Right: Quick tools -->
    <div style="display:flex;align-items:center;gap:18px;">
      ...
      <!-- Cart -->
      <a href="/Views/Users/cart.php" style="position:relative;color:#222;text-decoration:none;font-size:1.5rem;">
        🛒<span id="cart-badge" style="position:absolute;top:-8px;right:-10px;background:#ff6f61;color:#fff;font-size:0.9rem;padding:2px 7px;border-radius:12px;">0</span>
      </a>
      <!-- Account -->
      <a href="/Views/Users/auth.php" style="color:#222;text-decoration:none;font-size:1.5rem;">👤</a>
    </div>
  </div>
  <!-- Chatbot button -->
